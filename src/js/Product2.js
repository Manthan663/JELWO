...
function renderProducts(data) {
  TrendingProducts.innerHTML = products2
    ...
    <div class="h-[1.5px] bg-gray-400 mx-auto  mt-7"></div>
    ...
    <div class="absolute bottom-0 left-0 w-full bg-gray-50 p-10 opacity-0 group-hover:translate-y-0 group-hover:opacity-100">
